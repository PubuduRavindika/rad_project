<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $insert_ma = "INSERT INTO admin_table (admin_name, admin_nic, admin_email, admin_password, admin_type, first_time_login) VALUES ('$name', '$nic_number', '$email','$nic_number','ca','1')";
