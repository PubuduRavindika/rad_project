...
<head>
    ...
    <title>Third Year Selection Form</title>
...
<body>
    ...
    <div class="main_container">
        <form class="form" action="view_selected.php" method="POST">
            <div class="sub_container">
                <div class="sub_holder" onchange="special_selection_enabler()">
                    <h4>Special Subject</h4>
                    <p class="p1">Select maximum 3 subjects</p>
                ...
                <div class="sub_holder" onchange="jmajor_selection_enabler()">
                    ...
                    <p class="p1">Select maximum 3 combinations</p>
                    <div class="selection_box">
